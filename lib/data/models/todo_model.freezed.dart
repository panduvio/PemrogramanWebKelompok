...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String title, String description, bool progress});
}
...
class _$TodoModelImpl implements _TodoModel {
  _$TodoModelImpl(
      {required this.title, required this.description, this.progress = false});
  ...
  @override
  String toString() {
    return 'TodoModel(title: $title, description: $description, progress: $progress)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, title, description, progress);
...
abstract class _TodoModel implements TodoModel {
  factory _TodoModel(
      ...
      final bool progress}) = _$TodoModelImpl;
